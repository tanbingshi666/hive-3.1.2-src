...
public class HiveMetaStore extends ThriftHiveMetastore {
    ...
    public static class HMSHandler extends FacebookBase implements IHMSHandler {
         ...
         * @param tableNames The names of the tables to get.
         ...
         * @param db         Name of the database
         * @param tableName  Name of the table
         * @param envContext Store session based properties
         * @return List of columns, each column is a FieldSchema structure
         * @throws MetaException
         * @throws UnknownTableException
         * @throws UnknownDBException
    ...
    static public class HiveMetastoreCli extends CommonCliOptions {
        ...
        HiveMetastoreCli(Configuration configuration) {
            ...
            // 加载 hive-site.xml 文件内容并获取其 key = metastore.thrift.port 默认 9083
    ...
    public static void startMetaStore(int port, HadoopThriftAuthBridge bridge,
        ...
        try {
            ...
            if (useCompactProtocol) {
                ...
                // 创建 TBinaryProtocol.Factory()
                protocolFactory = new TBinaryProtocol.Factory();
                inputProtoFactory = new TBinaryProtocol.Factory(true, true, maxMessageSize, maxMessageSize);
            }
            // 创建 hive metastore Service HMSHandler(里面创建一个线程池 默认大小为 15)
            HMSHandler baseHandler = new HiveMetaStore.HMSHandler("new db based metaserver", conf,
                    false);
            // 获取 HMSHandler 的代理对象 (JDK 动态代理获取)
            ...
            if (tcpKeepAlive) {
                // 创建 TServerSocketKeepAlive (用来接收 Socket 客户端)
